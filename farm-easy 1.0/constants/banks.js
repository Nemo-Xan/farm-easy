...
Kenya Commercial BankFirst National Bank of Tanzania
...
const tz = tanzaniaBanks.split(/\r?\n/);

const banks = {
  NG: ngBanks.map(item => item.name.charAt(0).toUpperCase() + item.name.slice(1).toLowerCase()),
  TZ: tz
}
